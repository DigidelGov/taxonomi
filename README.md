# Samhällskontraktet i en digital tid
...
Detta verk är licensierat under [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/).

Du får fritt använda, anpassa och sprida materialet, även kommersiellt, så länge du anger källa.
